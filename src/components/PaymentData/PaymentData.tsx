...
const PaymentData: React.FC<IProps> = ({card, cardCredit}: any): any => {
    ...
    return (
        <div className={ (!componentPayment && giftPayment) || card ? 'payment__data__component' : 'close'}>
            <div className={(!componentPayment && giftPayment) ? 'payment__data' : 'close'}>
                <p>Applied gift card</p></div>
