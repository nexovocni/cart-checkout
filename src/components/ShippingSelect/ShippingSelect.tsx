    ...
    <React.Fragment>
      ...
      <div className="shipping__component__select">
        <div className="shipping__component__select__up">
              ...
              return (
                <div className="shipping__component__input">
                  ...
                  <input
                    ...
                    className={
                      input.value
                        ? 'shipping__component__postal'
                        : 'shipping__component__postal border'
                    }
                    {...input}
                  />
          ...
          <Field name="radius" type="select" component="input">
            {({ input, meta }) => {
              return (
                <div className="shipping__component__input select">
                  ...
                  <select
                    ...
                    className={
                      input.value
                        ? 'shipping__component__country'
                        : 'shipping__component__country border'
                    }
                    {...input}
                  >
                    <option selected={true} value="50">
                      50 Km
                    </option>
        ...
        <div className="shipping__component__select__down">
              ...
              return (
                <div className="shipping__component__input">
                  ...
                  <input
                    ...
                    className={
                      input.value
                        ? 'shipping__component__province'
                        : 'shipping__component__province border'
                    }
                    {...input}
                  />
                  {meta.error && meta.touched ? (
          ...
          <Field name="city-select" type="select" component="input">
            {({ input, meta }) => {
              return (
                <div className="shipping__component__input select">
                  <label
                  ...
                  <select
                    ...
                    className={
                      input.value
                        ? 'shipping__component__city-select'
                        : 'shipping__component__city-select border'
                    }
                    {...input}
                  >
