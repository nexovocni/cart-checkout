...
const MessageEmail: React.FC<IProps> = ({passwordBtn, submitBtn, input, validate}: IProps): any => {
    ...
    return (
        <div className={validate(input) && !componentPassword ? 'email__component__message' : 'email__component__message close'}>
