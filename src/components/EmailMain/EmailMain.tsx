...
const YourEmail: React.FC<IProps> = ({submitBtn, validateEmail, setInput}: IProps): any => {
    return (
                                ...
                                {({input, meta}: any): any => {
                                    ...
                                    return(
                                        <div className="email__component__field__email">
                                            ...
                                            <input placeholder="Email"  className={input.value ? 'email__component__input' : 'email__component__input border'} {...input} autoFocus={true}/>
