...
const PaymentCredit: React.FC<IProps> = ({validate, submitBtn, setCard, setCardCredit, cardValue}: IProps): any => {
                ...
                return(
                    <form onSubmit={props.handleSubmit} className="payment__component__form" >
                        ...
                        <Field
                            ...
                            validate={validate}
                        >
                            {({input, meta}: {input: any, meta: any}): any => {
                                setCard(input.value);
                                return(
                                <>
                                    ...
                                    <select placeholder="Country" className={input.value ? 'payment__component__credit__select select' : 'payment__component__credit__select select border'} {...input}>
                                        <option selected={true} hidden={true} value="">Chose a card</option>
                        ...
                        <div className="payment__component__shipping__sign"> <i className="fa fa-check" /></div>
