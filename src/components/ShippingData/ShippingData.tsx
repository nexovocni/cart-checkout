...
const ShippingData: React.FC<IProps> = ({firstName, lastName, firstAddress, lastAddress, postal, province, city, country, phone, firstNameAddress, lastNameAddress, phoneAddress}: IProps): any => {
