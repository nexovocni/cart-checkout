...
const PaymentButtons: React.FC<IProps> = ({openCredit, openGift}: IProps): any => {
    ...
    return (
        <div className={componentPayment ? 'payment__component__buttons' : 'close' }>
            ...
            <div className="payment__component__buttons__down">
                <button className="payment__component__button"><img className="apple" src="img/apple.svg" alt="apple"/></button>
                <button className="payment__component__button"><img className="paypay" src="img/pay.svg" alt="pay"/></button>
            </div>
        </div>
    );
};
